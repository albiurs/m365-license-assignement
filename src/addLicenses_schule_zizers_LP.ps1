...
$domain = "schule.zizers.ch"  # Replace with the desired domain

# SKU Identifiers to assign (e.g., SKU_LICENSE_IDENTIFIER_1, SKU_LICENSE_IDENTIFIER_2)
$skuIdentifiers = @("ENTERPRISEPACKPLUS_FACULTY", "FLOW_FREE", "POWERAPPS_VIRAL", "STREAM")  # Replace with the desired SKU Identifiers
